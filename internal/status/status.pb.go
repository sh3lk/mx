...
// Status describes the status of a MX application deployment.
type Status struct {
...
// Component describes a MX component.
...
type Replica struct {
	...
	MXNId string `protobuf:"bytes,2,opt,name=mxnId,proto3" json:"mxnId,omitempty"` // replica mxn id
}
...
func (x *Replica) GetMXNId() string {
	if x != nil {
		return x.MXNId
	}
	return ""
...
// Listener describes a MX listener.
