...
var (
	...
	// mx package. The circuitousness is to avoid cyclic dependencies.
	...
	// SetMXInfo sets the application's runtime information.
	SetMXInfo func(impl any, info *MXInfo) error
...
// Copy of the same struct in the main mx package.
type MXInfo struct {
