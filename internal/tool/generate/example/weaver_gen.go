...
func init() {
	codegen.Register(codegen.Registration{
		Name:      "github.com/sh3lk/mx/internal/tool/generate/example/A",
		Iface:     reflect.TypeOf((*A)(nil)).Elem(),
		Impl:      reflect.TypeOf(a{}),
		Routed:    true,
		Listeners: []string{"lis2", "renamed_listener"},
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return a_local_stub{impl: impl.(A), tracer: tracer, m1Metrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/internal/tool/generate/example/A", Method: "M1", Remote: false, Generated: true}), m2Metrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/internal/tool/generate/example/A", Method: "M2", Remote: false, Generated: true})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return a_client_stub{stub: stub, m1Metrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/internal/tool/generate/example/A", Method: "M1", Remote: true, Generated: true}), m2Metrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/internal/tool/generate/example/A", Method: "M2", Remote: true, Generated: true})}
		},
		...
		RefData: "⟦627f661b:MxEdge:github.com/sh3lk/mx/internal/tool/generate/example/A→github.com/sh3lk/mx/internal/tool/generate/example/B⟧\n⟦26168bd7:wEaVeRlIsTeNeRs:github.com/sh3lk/mx/internal/tool/generate/example/A→lis2,renamed_listener⟧\n",
	})
	codegen.Register(codegen.Registration{
		Name:      "github.com/sh3lk/mx/internal/tool/generate/example/B",
		Iface:     reflect.TypeOf((*B)(nil)).Elem(),
		Impl:      reflect.TypeOf(b{}),
		Routed:    true,
		Listeners: []string{"lis2", "renamed_listener"},
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return b_local_stub{impl: impl.(B), tracer: tracer, m1Metrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/internal/tool/generate/example/B", Method: "M1", Remote: false, Generated: true}), m2Metrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/internal/tool/generate/example/B", Method: "M2", Remote: false, Generated: true})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return b_client_stub{stub: stub, m1Metrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/internal/tool/generate/example/B", Method: "M1", Remote: true, Generated: true}), m2Metrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/internal/tool/generate/example/B", Method: "M2", Remote: true, Generated: true})}
		},
		ServerStubFn: func(impl any, addLoad func(uint64, float64)) codegen.Server {
		...
		RefData: "⟦6971bce2:MxEdge:github.com/sh3lk/mx/internal/tool/generate/example/B→github.com/sh3lk/mx/internal/tool/generate/example/A⟧\n⟦c9c43570:wEaVeRlIsTeNeRs:github.com/sh3lk/mx/internal/tool/generate/example/B→lis2,renamed_listener⟧\n",
	})
}

// mx.InstanceOf checks.
var _ mx.InstanceOf[A] = (*a)(nil)
var _ mx.InstanceOf[B] = (*b)(nil)

// mx.Router checks.
var _ mx.RoutedBy[router] = (*a)(nil)
var _ mx.RoutedBy[router] = (*b)(nil)
...
func (s a_client_stub) M1(ctx context.Context, a0 int, a1 string, a2 bool, a3 [10]int, a4 []string, a5 map[bool]int, a6 message) (r0 pair, err error) {
	...
	enc.String(a1)
	enc.Bool(a2)
	mx_enc_array_10_int_03f98313(enc, &a3)
	mx_enc_slice_string_4af10117(enc, a4)
	mx_enc_map_bool_int_acb668fa(enc, a5)
	(a6).MXMarshal(enc)
...
func (s a_server_stub) m1(ctx context.Context, args []byte) (res []byte, err error) {
	...
	a2 = dec.Bool()
	var a3 [10]int
	mx_dec_array_10_int_03f98313(dec, &a3)
	var a4 []string
	a4 = mx_dec_slice_string_4af10117(dec)
	var a5 map[bool]int
	a5 = mx_dec_map_bool_int_acb668fa(dec)
	var a6 message
	(&a6).MXUnmarshal(dec)
	var r router
...
func (x *message) MXMarshal(enc *codegen.Encoder) {
	if x == nil {
		panic(fmt.Errorf("message.MXMarshal: nil receiver"))
	}
	enc.Int(x.a)
	enc.String(x.b)
	enc.Bool(x.c)
	mx_enc_array_10_int_03f98313(enc, &x.d)
	mx_enc_slice_string_4af10117(enc, x.e)
	mx_enc_map_bool_int_acb668fa(enc, x.f)
}

func (x *message) MXUnmarshal(dec *codegen.Decoder) {
	if x == nil {
		panic(fmt.Errorf("message.MXUnmarshal: nil receiver"))
	}
	x.a = dec.Int()
	x.b = dec.String()
	x.c = dec.Bool()
	mx_dec_array_10_int_03f98313(dec, &x.d)
	x.e = mx_dec_slice_string_4af10117(dec)
	x.f = mx_dec_map_bool_int_acb668fa(dec)
}

func mx_enc_array_10_int_03f98313(enc *codegen.Encoder, arg *[10]int) {
	for i := 0; i < 10; i++ {
		enc.Int(arg[i])
	}
}

func mx_dec_array_10_int_03f98313(dec *codegen.Decoder, res *[10]int) {
	for i := 0; i < 10; i++ {
		res[i] = dec.Int()
	}
}
...
func mx_enc_map_bool_int_acb668fa(enc *codegen.Encoder, arg map[bool]int) {
	if arg == nil {
		enc.Len(-1)
		return
	}
...
func mx_dec_map_bool_int_acb668fa(dec *codegen.Decoder) map[bool]int {
	n := dec.Len()
	if n == -1 {
		return nil
	}
...
func (x *pair) MXMarshal(enc *codegen.Encoder) {
	if x == nil {
		panic(fmt.Errorf("pair.MXMarshal: nil receiver"))
	}
	(x.a).MXMarshal(enc)
	(x.b).MXMarshal(enc)
}

func (x *pair) MXUnmarshal(dec *codegen.Decoder) {
	if x == nil {
		panic(fmt.Errorf("pair.MXUnmarshal: nil receiver"))
	}
	(&x.a).MXUnmarshal(dec)
	(&x.b).MXUnmarshal(dec)
}
...
func (x *routingKey) MXMarshal(enc *codegen.Encoder) {
	if x == nil {
		panic(fmt.Errorf("routingKey.MXMarshal: nil receiver"))
	}
	enc.Int(x.a)
	enc.String(x.b)
	enc.Float32(x.c)
...
func (x *routingKey) MXUnmarshal(dec *codegen.Decoder) {
	if x == nil {
		panic(fmt.Errorf("routingKey.MXUnmarshal: nil receiver"))
	}
	x.a = dec.Int()
	x.b = dec.String()
	x.c = dec.Float32()
