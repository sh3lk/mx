...
func TestTranslateMetricsToPrometheus(t *testing.T) {
	...
	for _, c := range []testCase{
		...
		},
		{
			...
			[]*metrics.MetricSnapshot{
				{Id: 1, Name: "hello", Type: protos.MetricType_COUNTER, Value: 100},
				{Id: 3, Name: "mx_foo", Type: protos.MetricType_COUNTER, Value: 300},
			},
			[]string{
				`(?s)hello.*MX AUTOGENERATED.*mx_foo 300`, // MX metrics after user metrics
			},
		},
		{
			"labeled",
		...
		},
		{
			...
			[]*metrics.MetricSnapshot{
				{Id: 1, Name: "hello", Type: protos.MetricType_COUNTER,
					Labels: map[string]string{"mx_node": `123456789ABCDEF`},
					Value:  100},
			},
			[]string{
				`hello\{mx_node="12345678"\} 100`,
			},
		},
		{
			"histogram",
