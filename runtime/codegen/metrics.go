...
type MethodLabels struct {
	...
	Generated bool   `mx:"mx_generated"` // Is this an autogenerated metric?
}

// MethodMetrics contains metrics for a single MX component method.
