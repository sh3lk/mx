...
// HealthStatus specifies the health of a mxn.
...
// MXNArgs is the information provided by an envelope to a mxn when
// the mxn is created.
type MXNArgs struct {
	...
	Id           string `protobuf:"bytes,3,opt,name=id,proto3" json:"id,omitempty"`                                         // globally unique mxn id
	RunMain      bool   `protobuf:"varint,7,opt,name=run_main,json=runMain,proto3" json:"run_main,omitempty"`               // run the main function?
	// Should mxns establish mTLS connections with each other?
	Mtls bool `protobuf:"varint,8,opt,name=mtls,proto3" json:"mtls,omitempty"`
	// Address on which the mxn's internal network listener should listen on
	...
	// Unix domain socket path where mxn should serve Control component
	// method calls.
	ControlSocket string              `protobuf:"bytes,13,opt,name=control_socket,json=controlSocket,proto3" json:"control_socket,omitempty"`
	Redirects     []*MXNArgs_Redirect `protobuf:"bytes,12,rep,name=redirects,proto3" json:"redirects,omitempty"`
}

func (x *MXNArgs) Reset() {
	*x = MXNArgs{}
...
func (x *MXNArgs) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MXNArgs) ProtoMessage() {}

func (x *MXNArgs) ProtoReflect() protoreflect.Message {
	mi := &file_runtime_protos_runtime_proto_msgTypes[0]
...
// Deprecated: Use MXNArgs.ProtoReflect.Descriptor instead.
func (*MXNArgs) Descriptor() ([]byte, []int) {
	return file_runtime_protos_runtime_proto_rawDescGZIP(), []int{0}
}

func (x *MXNArgs) GetApp() string {
	if x != nil {
		return x.App
	}
	return ""
...
func (x *MXNArgs) GetDeploymentId() string {
	if x != nil {
...
func (x *MXNArgs) GetRunMain() bool {
	if x != nil {
		return x.RunMain
	}
	return false
...
func (x *MXNArgs) GetInternalAddress() string {
	if x != nil {
...
func (x *MXNArgs) GetControlSocket() string {
	if x != nil {
...
func (x *MXNArgs) GetRedirects() []*MXNArgs_Redirect {
	if x != nil {
		return x.Redirects
	}
	return nil
...
// InitMXNRequest holds the initialization info passed to the mxn by the envelope.
type InitMXNRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *InitMXNRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InitMXNRequest) ProtoMessage() {}

func (x *InitMXNRequest) ProtoReflect() protoreflect.Message {
	mi := &file_runtime_protos_runtime_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InitMXNRequest.ProtoReflect.Descriptor instead.
func (*InitMXNRequest) Descriptor() ([]byte, []int) {
	return file_runtime_protos_runtime_proto_rawDescGZIP(), []int{1}
}

func (x *InitMXNRequest) GetSections() map[string]string {
	if x != nil {
		return x.Sections
	}
	return nil
...
// InitMXNReply is the information provided by a mxn to an envelope during
// the initial envelope-mxn handshake.
type InitMXNReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Internal TCP address of the mxn. This address will be passed to other
	// mxns as part of their RoutingInfo.
	DialAddr string `protobuf:"bytes,1,opt,name=dial_addr,json=dialAddr,proto3" json:"dial_addr,omitempty"`
	// The deployer API version of the mxn.
	Version *SemVer `protobuf:"bytes,3,opt,name=version,proto3" json:"version,omitempty"`
}

func (x *InitMXNReply) Reset() {
	*x = InitMXNReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *InitMXNReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InitMXNReply) ProtoMessage() {}

func (x *InitMXNReply) ProtoReflect() protoreflect.Message {
	mi := &file_runtime_protos_runtime_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InitMXNReply.ProtoReflect.Descriptor instead.
func (*InitMXNReply) Descriptor() ([]byte, []int) {
	return file_runtime_protos_runtime_proto_rawDescGZIP(), []int{2}
}

func (x *InitMXNReply) GetDialAddr() string {
	if x != nil {
		return x.DialAddr
	}
	return ""
...
func (x *InitMXNReply) GetVersion() *SemVer {
	if x != nil {
		return x.Version
	}
	return nil
...
// GetHealthRequest is a request from an envelope for a mxn's health.
...
// GetMetricsRequest is a request from an envelope for a mxn's metrics.
...
// GetLoadRequest is a request from an envelope for a mxn's load report.
...
// GetProfileRequest is a request from an envelope for a mxn to collect and
...
// UpdateRoutingInfoRequest is a request from an envelope to the mxn to
...
// RoutingInfo contains routing information for a component. A mxn uses a
...
type RoutingInfo struct {
	...
	// The addresses of the mxns hosting a replica of the component. Every
	// address is of the form "<net>://<addr>" (e.g., "tcp://host:1234",
	// "unix:///tmp/unix.sock"). For non-local components, a mxn will execute
...
// UpdateComponentsRequest is a request from an envelope to the mxn to
...
// ActivateComponentRequest is a request from a mxn to ensure that the
// provided component is running somewhere. An ActivateComponentRequest also
// implicitly signals that a mxn is interested in receiving routing info
...
// GetListenerAddressRequest is a request from a mxn for the address the
// mxn should listen on for a particular listener.
//
// Imagine a mxn calls GetListener with LocalAdress localhost:9000. Here
// are some examples of how different deployers may handle a
// GetListenerAddressRequest.
//
//   - The singleprocess deployer may instruct the mxn to listen directly
//     on localhost:9000.
//   - The multiprocess deployer may instruct the mxn to listen on
//     localhost:0. It will separately start a proxy on localhost:9000.
//   - The SSH deployer may instruct the mxn to listen on
...
// ExportListenerRequest is a request from a mxn to export the provided
...
type ExportListenerReply struct {
	...
	//
	// TODO(mwhittaker): This field exists as a hack to avoid a mxn retrying
...
// GetSelfCertificateRequest is a request from a mxn for its certificate
...
type GetSelfCertificateReply struct {
	...
	// mxn and (2) the corresponding private key. Used for enforcing mTLS
	// security across components.
	Cert []byte `protobuf:"bytes,1,opt,name=cert,proto3" json:"cert,omitempty"` // certificate identifying the mxn
...
// VerifyClientCertificateRequest is a request from a mxn to verify
// the identity of a client that is attempting to connect to the mxn.
...
type VerifyClientCertificateReply struct {
	...
	// The set of components hosted by the mxn that the client is allowed to
	// invoke methods on.
	Components []string `protobuf:"bytes,1,rep,name=components,proto3" json:"components,omitempty"`
}
...
// VerifyServerCertificateRequest is a request from a mxn to verify
...
type LogEntry struct {
	...
	Node       string `protobuf:"bytes,4,opt,name=node,proto3" json:"node,omitempty"`                                 // mxn id
...
// A redirect entry instructs the mxn to direct calls made to component
// to be instead sent to the component named target at the specified address.
type MXNArgs_Redirect struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *MXNArgs_Redirect) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MXNArgs_Redirect) ProtoMessage() {}

func (x *MXNArgs_Redirect) ProtoReflect() protoreflect.Message {
	mi := &file_runtime_protos_runtime_proto_msgTypes[39]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MXNArgs_Redirect.ProtoReflect.Descriptor instead.
func (*MXNArgs_Redirect) Descriptor() ([]byte, []int) {
	return file_runtime_protos_runtime_proto_rawDescGZIP(), []int{0, 0}
}

func (x *MXNArgs_Redirect) GetComponent() string {
	if x != nil {
		return x.Component
	}
	return ""
...
func (x *MXNArgs_Redirect) GetTarget() string {
	if x != nil {
		return x.Target
	}
	return ""
...
func (x *MXNArgs_Redirect) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
//
// TODO(mwhittaker): In the short term, a mxn will report one SliceLoad
...
type LoadReport_SliceLoad struct {
	...
	//     used. For example, a mxn with slice [0, 2^60) may only
...
// Resource describes an entity (e.g., a MX component) this span
// belongs to.
...
var file_runtime_protos_runtime_proto_goTypes = []interface{}{
	...
	(*MXNArgs)(nil),                         // 6: runtime.MXNArgs
	(*InitMXNRequest)(nil),                  // 7: runtime.InitMXNRequest
	(*InitMXNReply)(nil),                    // 8: runtime.InitMXNReply
	...
	(*MXNArgs_Redirect)(nil),                // 45: runtime.MXNArgs.Redirect
	nil,                                     // 46: runtime.InitMXNRequest.SectionsEntry
...
var file_runtime_protos_runtime_proto_depIdxs = []int32{
	45, // 0: runtime.MXNArgs.redirects:type_name -> runtime.MXNArgs.Redirect
	46, // 1: runtime.InitMXNRequest.sections:type_name -> runtime.InitMXNRequest.SectionsEntry
	9,  // 2: runtime.InitMXNReply.version:type_name -> runtime.SemVer
