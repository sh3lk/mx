...
// in log entries generated by MX system components.
const SystemAttributeKey = "mx/system"
...
type Options struct {
	App        string // MX application (e.g., "todo")
	Deployment string // MX deployment (e.g., "36105c89-85b1...")
	Component  string // MX component (e.g., "Todo")
	MXN        string // MX mxn id (e.g., "36105c89-85b1...")
...
func (t *TestLogger) Log(entry *protos.LogEntry) {
	...
	case !t.verbose:
		...
		// override this behavior because, otherwise, mxtest benchmark
...
func NewTestSlogger(t TB, verbose bool) *slog.Logger {
	...
	return slog.New(&LogHandler{
		Opts:  Options{Component: "TestLogger", MXN: uuid.New().String()},
		Write: logger.Log,
	})
}
