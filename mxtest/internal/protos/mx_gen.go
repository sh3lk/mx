...
func init() {
	codegen.Register(codegen.Registration{
		Name:  "github.com/sh3lk/mx/mxtest/internal/protos/PingPonger",
		Iface: reflect.TypeOf((*PingPonger)(nil)).Elem(),
		Impl:  reflect.TypeOf(impl{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return pingPonger_local_stub{impl: impl.(PingPonger), tracer: tracer, pingMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/protos/PingPonger", Method: "Ping", Remote: false, Generated: true})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return pingPonger_client_stub{stub: stub, pingMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/protos/PingPonger", Method: "Ping", Remote: true, Generated: true})}
		},
...
var _ mx.InstanceOf[PingPonger] = (*impl)(nil)
...
func (s pingPonger_client_stub) Ping(ctx context.Context, a0 *Ping) (r0 *Pong, err error) {
	...
	mx_enc_ptr_Ping_53efca65(enc, a0)
	var shardKey uint64
	...
	r0 = mx_dec_ptr_Pong_10ae1a4e(dec)
	err = dec.Error()
	return
}
...
func (s pingPonger_server_stub) ping(ctx context.Context, args []byte) (res []byte, err error) {
	...
	var a0 *Ping
	a0 = mx_dec_ptr_Ping_53efca65(dec)
	...
	// Encode the results.
	enc := codegen.NewEncoder()
	mx_enc_ptr_Pong_10ae1a4e(enc, r0)
	enc.Error(appErr)
	return enc.Data(), nil
}
...
func mx_enc_ptr_Ping_53efca65(enc *codegen.Encoder, arg *Ping) {
	if arg == nil {
		enc.Bool(false)
	} else {
		enc.Bool(true)
...
func mx_dec_ptr_Ping_53efca65(dec *codegen.Decoder) *Ping {
	if !dec.Bool() {
		return nil
	}
	var res Ping
...
func mx_enc_ptr_Pong_10ae1a4e(enc *codegen.Encoder, arg *Pong) {
	if arg == nil {
		enc.Bool(false)
	} else {
		enc.Bool(true)
...
func mx_dec_ptr_Pong_10ae1a4e(dec *codegen.Decoder) *Pong {
	if !dec.Bool() {
		return nil
	}
	var res Pong
