...
func init() {
	codegen.Register(codegen.Registration{
		Name:    "github.com/sh3lk/mx/mxtest/internal/simple/Destination",
		Iface:   reflect.TypeOf((*Destination)(nil)).Elem(),
		Impl:    reflect.TypeOf(destination{}),
		Routed:  true,
		NoRetry: []int{3, 4},
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return destination_local_stub{impl: impl.(Destination), tracer: tracer, getAllMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/simple/Destination", Method: "GetAll", Remote: false, Generated: true}), getMetadataMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/simple/Destination", Method: "GetMetadata", Remote: false, Generated: true}), getpidMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/simple/Destination", Method: "Getpid", Remote: false, Generated: true}), recordMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/simple/Destination", Method: "Record", Remote: false, Generated: true}), routedRecordMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/simple/Destination", Method: "RoutedRecord", Remote: false, Generated: true}), updateMetadataMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/simple/Destination", Method: "UpdateMetadata", Remote: false, Generated: true})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return destination_client_stub{stub: stub, getAllMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/simple/Destination", Method: "GetAll", Remote: true, Generated: true}), getMetadataMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/simple/Destination", Method: "GetMetadata", Remote: true, Generated: true}), getpidMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/simple/Destination", Method: "Getpid", Remote: true, Generated: true}), recordMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/simple/Destination", Method: "Record", Remote: true, Generated: true}), routedRecordMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/simple/Destination", Method: "RoutedRecord", Remote: true, Generated: true}), updateMetadataMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/simple/Destination", Method: "UpdateMetadata", Remote: true, Generated: true})}
		},
	...
	codegen.Register(codegen.Registration{
		Name:      "github.com/sh3lk/mx/mxtest/internal/simple/Server",
		Iface:     reflect.TypeOf((*Server)(nil)).Elem(),
		Impl:      reflect.TypeOf(server{}),
		Listeners: []string{"hello"},
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return server_local_stub{impl: impl.(Server), tracer: tracer, addressMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/simple/Server", Method: "Address", Remote: false, Generated: true}), proxyAddressMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/simple/Server", Method: "ProxyAddress", Remote: false, Generated: true}), shutdownMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/simple/Server", Method: "Shutdown", Remote: false, Generated: true})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return server_client_stub{stub: stub, addressMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/simple/Server", Method: "Address", Remote: true, Generated: true}), proxyAddressMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/simple/Server", Method: "ProxyAddress", Remote: true, Generated: true}), shutdownMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/simple/Server", Method: "Shutdown", Remote: true, Generated: true})}
		},
		ServerStubFn: func(impl any, addLoad func(uint64, float64)) codegen.Server {
		...
		RefData: "⟦1e2dce71:wEaVeRlIsTeNeRs:github.com/sh3lk/mx/mxtest/internal/simple/Server→hello⟧\n",
	})
	codegen.Register(codegen.Registration{
		Name:    "github.com/sh3lk/mx/mxtest/internal/simple/Source",
		Iface:   reflect.TypeOf((*Source)(nil)).Elem(),
		Impl:    reflect.TypeOf(source{}),
		NoRetry: []int{0},
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return source_local_stub{impl: impl.(Source), tracer: tracer, emitMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/simple/Source", Method: "Emit", Remote: false, Generated: true})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return source_client_stub{stub: stub, emitMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/simple/Source", Method: "Emit", Remote: true, Generated: true})}
		},
		ServerStubFn: func(impl any, addLoad func(uint64, float64)) codegen.Server {
		...
		RefData: "⟦bf914175:MxEdge:github.com/sh3lk/mx/mxtest/internal/simple/Source→github.com/sh3lk/mx/mxtest/internal/simple/Destination⟧\n",
	})
}

// mx.InstanceOf checks.
var _ mx.InstanceOf[Destination] = (*destination)(nil)
var _ mx.InstanceOf[Server] = (*server)(nil)
var _ mx.InstanceOf[Source] = (*source)(nil)

// mx.Router checks.
var _ mx.RoutedBy[destRouter] = (*destination)(nil)
var _ mx.Unrouted = (*server)(nil)
var _ mx.Unrouted = (*source)(nil)

// Component "destination", router "destRouter" checks.
type __destination_destRouter_if_youre_seeing_this_you_probably_forgot_to_run_mx_generate struct {
	destRouter
...
var _ = (&__destination_destRouter_if_youre_seeing_this_you_probably_forgot_to_run_mx_generate{}).GetAll         // unrouted
var _ = (&__destination_destRouter_if_youre_seeing_this_you_probably_forgot_to_run_mx_generate{}).GetMetadata    // unrouted
var _ = (&__destination_destRouter_if_youre_seeing_this_you_probably_forgot_to_run_mx_generate{}).Getpid         // unrouted
var _ = (&__destination_destRouter_if_youre_seeing_this_you_probably_forgot_to_run_mx_generate{}).Record         // unrouted
var _ = (&__destination_destRouter_if_youre_seeing_this_you_probably_forgot_to_run_mx_generate{}).UpdateMetadata // unrouted
...
func (s destination_client_stub) GetAll(ctx context.Context, a0 string) (r0 []string, err error) {
	...
	r0 = mx_dec_slice_string_4af10117(dec)
	err = dec.Error()
	return
}
...
func (s destination_client_stub) GetMetadata(ctx context.Context) (r0 map[string]string, err error) {
	...
	// Decode the results.
	dec := codegen.NewDecoder(results)
	r0 = mx_dec_map_string_string_219dd46d(dec)
	err = dec.Error()
	return
}
...
func (s destination_server_stub) getAll(ctx context.Context, args []byte) (res []byte, err error) {
	...
	// Encode the results.
	enc := codegen.NewEncoder()
	mx_enc_slice_string_4af10117(enc, r0)
	enc.Error(appErr)
	return enc.Data(), nil
}
...
func (s destination_server_stub) getMetadata(ctx context.Context, args []byte) (res []byte, err error) {
	...
	// Encode the results.
	enc := codegen.NewEncoder()
	mx_enc_map_string_string_219dd46d(enc, r0)
	enc.Error(appErr)
	return enc.Data(), nil
}
...
func mx_enc_map_string_string_219dd46d(enc *codegen.Encoder, arg map[string]string) {
	if arg == nil {
		enc.Len(-1)
		return
	}
...
func mx_dec_map_string_string_219dd46d(dec *codegen.Decoder) map[string]string {
	n := dec.Len()
	if n == -1 {
		return nil
	}
