...
func init() {
	codegen.Register(codegen.Registration{
		Name:  "github.com/sh3lk/mx/mxtest/internal/deploy/Started",
		Iface: reflect.TypeOf((*Started)(nil)).Elem(),
		Impl:  reflect.TypeOf(started{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return started_local_stub{impl: impl.(Started), tracer: tracer, markStartedMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/deploy/Started", Method: "MarkStarted", Remote: false, Generated: true})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return started_client_stub{stub: stub, markStartedMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/deploy/Started", Method: "MarkStarted", Remote: true, Generated: true})}
		},
	...
	codegen.Register(codegen.Registration{
		Name:  "github.com/sh3lk/mx/mxtest/internal/deploy/Widget",
		Iface: reflect.TypeOf((*Widget)(nil)).Elem(),
		Impl:  reflect.TypeOf(widget{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return widget_local_stub{impl: impl.(Widget), tracer: tracer, useMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/deploy/Widget", Method: "Use", Remote: false, Generated: true})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return widget_client_stub{stub: stub, useMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/deploy/Widget", Method: "Use", Remote: true, Generated: true})}
		},
		ServerStubFn: func(impl any, addLoad func(uint64, float64)) codegen.Server {
		...
		RefData: "⟦f3fa3c18:MxEdge:github.com/sh3lk/mx/mxtest/internal/deploy/Widget→github.com/sh3lk/mx/mxtest/internal/deploy/Started⟧\n",
	})
}

// mx.InstanceOf checks.
var _ mx.InstanceOf[Started] = (*started)(nil)
var _ mx.InstanceOf[Widget] = (*widget)(nil)

// mx.Router checks.
var _ mx.Unrouted = (*started)(nil)
var _ mx.Unrouted = (*widget)(nil)
