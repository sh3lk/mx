...
func TestOneComponentImpl(t *testing.T) {
	// Tests mx.Test with a component implementation pointer argument.
...
func BenchOneComponentImpl(b *testing.B) {
	// Tests mx.Bench with a component implementation pointer argument.
	for _, runner := range mxtest.AllRunners() {
...
func TestTwoComponentImpls(t *testing.T) {
	// Tests mx.Test with two component implementation pointer arguments.
	for _, runner := range mxtest.AllRunners() {
...
func TestOverlappingComponentInterfaceAndImpl(t *testing.T) {
	// Tests mx.Test with an A argument and an *a argument. The underlying
...
func TestOverlappingComponentInterfaceAndFake(t *testing.T) {
	// Tests mx.Test with an A argument and fake A implementation. The
	// underlying implementation of the A argument should be the fake.
	for _, runner := range mxtest.AllRunners() {
		fake := &fakea{}
		runner.Fakes = append(runner.Fakes, mxtest.Fake[A](fake))
