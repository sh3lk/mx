...
func init() {
	codegen.Register(codegen.Registration{
		Name:  "github.com/sh3lk/mx/mxtest/internal/generate/testApp",
		Iface: reflect.TypeOf((*testApp)(nil)).Elem(),
		Impl:  reflect.TypeOf(impl{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return testApp_local_stub{impl: impl.(testApp), tracer: tracer, divModMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/generate/testApp", Method: "DivMod", Remote: false, Generated: true}), getMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/generate/testApp", Method: "Get", Remote: false, Generated: true}), incPointerMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/generate/testApp", Method: "IncPointer", Remote: false, Generated: true})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return testApp_client_stub{stub: stub, divModMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/generate/testApp", Method: "DivMod", Remote: true, Generated: true}), getMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/generate/testApp", Method: "Get", Remote: true, Generated: true}), incPointerMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/generate/testApp", Method: "IncPointer", Remote: true, Generated: true})}
		},
...
var _ mx.InstanceOf[testApp] = (*impl)(nil)
...
func (s testApp_client_stub) IncPointer(ctx context.Context, a0 *int) (r0 *int, err error) {
	...
	// Preallocate a buffer of the right size.
	size := 0
	size += mx_size_ptr_int_98a2a745(a0)
	enc := codegen.NewEncoder()
	enc.Reset(size)

	// Encode arguments.
	mx_enc_ptr_int_98a2a745(enc, a0)
	var shardKey uint64
	...
	// Decode the results.
	dec := codegen.NewDecoder(results)
	r0 = mx_dec_ptr_int_98a2a745(dec)
	err = dec.Error()
	return
}
...
func (s testApp_server_stub) incPointer(ctx context.Context, args []byte) (res []byte, err error) {
	...
	dec := codegen.NewDecoder(args)
	var a0 *int
	a0 = mx_dec_ptr_int_98a2a745(dec)
	...
	// Encode the results.
	enc := codegen.NewEncoder()
	mx_enc_ptr_int_98a2a745(enc, r0)
	enc.Error(appErr)
	return enc.Data(), nil
}
...
func (x *customErrorValue) MXMarshal(enc *codegen.Encoder) {
	if x == nil {
		panic(fmt.Errorf("customErrorValue.MXMarshal: nil receiver"))
	}
	enc.String(x.key)
}

func (x *customErrorValue) MXUnmarshal(dec *codegen.Decoder) {
	if x == nil {
		panic(fmt.Errorf("customErrorValue.MXUnmarshal: nil receiver"))
	}
	x.key = dec.String()
}
...
func mx_enc_ptr_int_98a2a745(enc *codegen.Encoder, arg *int) {
	if arg == nil {
		enc.Bool(false)
	} else {
		enc.Bool(true)
...
func mx_dec_ptr_int_98a2a745(dec *codegen.Decoder) *int {
	if !dec.Bool() {
		return nil
	}
	var res int
...
// mx_size_ptr_int_98a2a745 returns the size (in bytes) of the serialization
// of the provided type.
func mx_size_ptr_int_98a2a745(x *int) int {
	if x == nil {
		return 1
	} else {
		return 1 + 8
