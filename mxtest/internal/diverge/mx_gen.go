...
func init() {
	codegen.Register(codegen.Registration{
		Name:  "github.com/sh3lk/mx/mxtest/internal/diverge/Errer",
		Iface: reflect.TypeOf((*Errer)(nil)).Elem(),
		Impl:  reflect.TypeOf(errer{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return errer_local_stub{impl: impl.(Errer), tracer: tracer, errMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/diverge/Errer", Method: "Err", Remote: false, Generated: true})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return errer_client_stub{stub: stub, errMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/diverge/Errer", Method: "Err", Remote: true, Generated: true})}
		},
	...
	codegen.Register(codegen.Registration{
		Name:  "github.com/sh3lk/mx/mxtest/internal/diverge/Pointer",
		Iface: reflect.TypeOf((*Pointer)(nil)).Elem(),
		Impl:  reflect.TypeOf(pointer{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return pointer_local_stub{impl: impl.(Pointer), tracer: tracer, getMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/diverge/Pointer", Method: "Get", Remote: false, Generated: true})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return pointer_client_stub{stub: stub, getMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/mxtest/internal/diverge/Pointer", Method: "Get", Remote: true, Generated: true})}
		},
		ServerStubFn: func(impl any, addLoad func(uint64, float64)) codegen.Server {
...
var _ mx.InstanceOf[Errer] = (*errer)(nil)
var _ mx.InstanceOf[Pointer] = (*pointer)(nil)

// mx.Router checks.
var _ mx.Unrouted = (*errer)(nil)
var _ mx.Unrouted = (*pointer)(nil)
...
func (x *Pair) MXMarshal(enc *codegen.Encoder) {
	...
	mx_enc_ptr_int_98a2a745(enc, x.X)
	mx_enc_ptr_int_98a2a745(enc, x.Y)
}
...
func (x *Pair) MXUnmarshal(dec *codegen.Decoder) {
	...
	x.X = mx_dec_ptr_int_98a2a745(dec)
	x.Y = mx_dec_ptr_int_98a2a745(dec)
}
