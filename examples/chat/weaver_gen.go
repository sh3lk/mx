...
func init() {
	codegen.Register(codegen.Registration{
		Name:  "github.com/sh3lk/mx/examples/chat/ImageScaler",
		Iface: reflect.TypeOf((*ImageScaler)(nil)).Elem(),
		Impl:  reflect.TypeOf(scaler{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return imageScaler_local_stub{impl: impl.(ImageScaler), tracer: tracer, scaleMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/examples/chat/ImageScaler", Method: "Scale", Remote: false, Generated: true})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return imageScaler_client_stub{stub: stub, scaleMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/examples/chat/ImageScaler", Method: "Scale", Remote: true, Generated: true})}
		},
	...
	codegen.Register(codegen.Registration{
		Name:  "github.com/sh3lk/mx/examples/chat/LocalCache",
		Iface: reflect.TypeOf((*LocalCache)(nil)).Elem(),
		Impl:  reflect.TypeOf(localCache{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return localCache_local_stub{impl: impl.(LocalCache), tracer: tracer, getMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/examples/chat/LocalCache", Method: "Get", Remote: false, Generated: true}), putMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/examples/chat/LocalCache", Method: "Put", Remote: false, Generated: true})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
	...
	codegen.Register(codegen.Registration{
		...
		RefData: "⟦7e1a0aa0:MxEdge:github.com/sh3lk/mx/Main→github.com/sh3lk/mx/examples/chat/SQLStore⟧\n⟦ae108c0d:MxEdge:github.com/sh3lk/mx/Main→github.com/sh3lk/mx/examples/chat/ImageScaler⟧\n⟦c86a1d44:MxEdge:github.com/sh3lk/mx/Main→github.com/sh3lk/mx/examples/chat/LocalCache⟧\n⟦7b9a3b0b:wEaVeRlIsTeNeRs:github.com/sh3lk/mx/Main→chat⟧\n",
	})
	codegen.Register(codegen.Registration{
		Name:    "github.com/sh3lk/mx/examples/chat/SQLStore",
		Iface:   reflect.TypeOf((*SQLStore)(nil)).Elem(),
		Impl:    reflect.TypeOf(sqlStore{}),
		NoRetry: []int{0, 1},
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return sQLStore_local_stub{impl: impl.(SQLStore), tracer: tracer, createPostMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/examples/chat/SQLStore", Method: "CreatePost", Remote: false, Generated: true}), createThreadMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/examples/chat/SQLStore", Method: "CreateThread", Remote: false, Generated: true}), getFeedMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/examples/chat/SQLStore", Method: "GetFeed", Remote: false, Generated: true}), getImageMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/examples/chat/SQLStore", Method: "GetImage", Remote: false, Generated: true})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return sQLStore_client_stub{stub: stub, createPostMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/examples/chat/SQLStore", Method: "CreatePost", Remote: true, Generated: true}), createThreadMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/examples/chat/SQLStore", Method: "CreateThread", Remote: true, Generated: true}), getFeedMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/examples/chat/SQLStore", Method: "GetFeed", Remote: true, Generated: true}), getImageMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/examples/chat/SQLStore", Method: "GetImage", Remote: true, Generated: true})}
		},
		ServerStubFn: func(impl any, addLoad func(uint64, float64)) codegen.Server {
...
var _ mx.InstanceOf[ImageScaler] = (*scaler)(nil)
var _ mx.InstanceOf[LocalCache] = (*localCache)(nil)
var _ mx.InstanceOf[mx.Main] = (*server)(nil)
var _ mx.InstanceOf[SQLStore] = (*sqlStore)(nil)

// mx.Router checks.
var _ mx.Unrouted = (*scaler)(nil)
var _ mx.Unrouted = (*localCache)(nil)
var _ mx.Unrouted = (*server)(nil)
var _ mx.Unrouted = (*sqlStore)(nil)
...
func (s imageScaler_client_stub) Scale(ctx context.Context, a0 []byte, a1 int, a2 int) (r0 []byte, err error) {
	...
	// Encode arguments.
	mx_enc_slice_byte_87461245(enc, a0)
	enc.Int(a1)
	enc.Int(a2)
	var shardKey uint64
	...
	r0 = mx_dec_slice_byte_87461245(dec)
	err = dec.Error()
	return
}
...
func (s sQLStore_client_stub) CreateThread(ctx context.Context, a0 string, a1 time.Time, a2 []string, a3 string, a4 []byte) (r0 ThreadID, err error) {
	...
	enc.String(a0)
	enc.EncodeBinaryMarshaler(&a1)
	mx_enc_slice_string_4af10117(enc, a2)
	enc.String(a3)
	mx_enc_slice_byte_87461245(enc, a4)
	var shardKey uint64
...
func (s sQLStore_client_stub) GetFeed(ctx context.Context, a0 string) (r0 []Thread, err error) {
	...
	// Decode the results.
	dec := codegen.NewDecoder(results)
	r0 = mx_dec_slice_Thread_511e1469(dec)
	err = dec.Error()
	return
}
...
func (s imageScaler_server_stub) scale(ctx context.Context, args []byte) (res []byte, err error) {
	...
	var a0 []byte
	a0 = mx_dec_slice_byte_87461245(dec)
	var a1 int
	a1 = dec.Int()
	var a2 int
	a2 = dec.Int()
	...
	// Encode the results.
	enc := codegen.NewEncoder()
	mx_enc_slice_byte_87461245(enc, r0)
	enc.Error(appErr)
	return enc.Data(), nil
}
...
func (s sQLStore_server_stub) createThread(ctx context.Context, args []byte) (res []byte, err error) {
	...
	dec.DecodeBinaryUnmarshaler(&a1)
	var a2 []string
	a2 = mx_dec_slice_string_4af10117(dec)
	var a3 string
	a3 = dec.String()
	var a4 []byte
	a4 = mx_dec_slice_byte_87461245(dec)
...
func (s sQLStore_server_stub) getFeed(ctx context.Context, args []byte) (res []byte, err error) {
	...
	// Encode the results.
	enc := codegen.NewEncoder()
	mx_enc_slice_Thread_511e1469(enc, r0)
	enc.Error(appErr)
	return enc.Data(), nil
}
...
func (x *Post) MXMarshal(enc *codegen.Encoder) {
	if x == nil {
		panic(fmt.Errorf("Post.MXMarshal: nil receiver"))
	}
...
func (x *Post) MXUnmarshal(dec *codegen.Decoder) {
	if x == nil {
		panic(fmt.Errorf("Post.MXUnmarshal: nil receiver"))
	}
...
func (x *Thread) MXMarshal(enc *codegen.Encoder) {
	if x == nil {
		panic(fmt.Errorf("Thread.MXMarshal: nil receiver"))
	}
	enc.Int64((int64)(x.ID))
	mx_enc_slice_Post_29a9ee83(enc, x.Posts)
}

func (x *Thread) MXUnmarshal(dec *codegen.Decoder) {
	if x == nil {
		panic(fmt.Errorf("Thread.MXUnmarshal: nil receiver"))
	}
	*(*int64)(&x.ID) = dec.Int64()
	x.Posts = mx_dec_slice_Post_29a9ee83(dec)
}

func mx_enc_slice_Post_29a9ee83(enc *codegen.Encoder, arg []Post) {
	if arg == nil {
		enc.Len(-1)
		return
	}
...
func mx_dec_slice_Post_29a9ee83(dec *codegen.Decoder) []Post {
	n := dec.Len()
	if n == -1 {
		return nil
	}
...
func mx_enc_slice_Thread_511e1469(enc *codegen.Encoder, arg []Thread) {
	if arg == nil {
		enc.Len(-1)
		return
	}
...
func mx_dec_slice_Thread_511e1469(dec *codegen.Decoder) []Thread {
	n := dec.Len()
	if n == -1 {
		return nil
	}
