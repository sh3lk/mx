...
func init() {
	codegen.Register(codegen.Registration{
		Name:  "github.com/sh3lk/mx/examples/collatz/Even",
		Iface: reflect.TypeOf((*Even)(nil)).Elem(),
		Impl:  reflect.TypeOf(even{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return even_local_stub{impl: impl.(Even), tracer: tracer, doMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/examples/collatz/Even", Method: "Do", Remote: false, Generated: true})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return even_client_stub{stub: stub, doMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/examples/collatz/Even", Method: "Do", Remote: true, Generated: true})}
		},
	...
	codegen.Register(codegen.Registration{
		...
		RefData: "⟦f95ad2dd:MxEdge:github.com/sh3lk/mx/Main→github.com/sh3lk/mx/examples/collatz/Odd⟧\n⟦987c175b:MxEdge:github.com/sh3lk/mx/Main→github.com/sh3lk/mx/examples/collatz/Even⟧\n⟦f3b62957:wEaVeRlIsTeNeRs:github.com/sh3lk/mx/Main→collatz⟧\n",
	})
	codegen.Register(codegen.Registration{
		Name:  "github.com/sh3lk/mx/examples/collatz/Odd",
		Iface: reflect.TypeOf((*Odd)(nil)).Elem(),
		Impl:  reflect.TypeOf(odd{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return odd_local_stub{impl: impl.(Odd), tracer: tracer, doMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/examples/collatz/Odd", Method: "Do", Remote: false, Generated: true})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return odd_client_stub{stub: stub, doMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/examples/collatz/Odd", Method: "Do", Remote: true, Generated: true})}
		},
		ServerStubFn: func(impl any, addLoad func(uint64, float64)) codegen.Server {
...
var _ mx.InstanceOf[Even] = (*even)(nil)
var _ mx.InstanceOf[mx.Main] = (*server)(nil)
var _ mx.InstanceOf[Odd] = (*odd)(nil)

// mx.Router checks.
var _ mx.Unrouted = (*even)(nil)
var _ mx.Unrouted = (*server)(nil)
var _ mx.Unrouted = (*odd)(nil)
