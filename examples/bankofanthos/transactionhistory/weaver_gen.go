...
func init() {
	codegen.Register(codegen.Registration{
		Name:  "github.com/sh3lk/mx/examples/bankofanthos/transactionhistory/T",
		Iface: reflect.TypeOf((*T)(nil)).Elem(),
		Impl:  reflect.TypeOf(impl{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return t_local_stub{impl: impl.(T), tracer: tracer, getTransactionsMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/examples/bankofanthos/transactionhistory/T", Method: "GetTransactions", Remote: false, Generated: true})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return t_client_stub{stub: stub, getTransactionsMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/examples/bankofanthos/transactionhistory/T", Method: "GetTransactions", Remote: true, Generated: true})}
		},
...
func (s t_client_stub) GetTransactions(ctx context.Context, a0 string) (r0 []model.Transaction, err error) {
	...
	r0 = mx_dec_slice_Transaction_d2a36fba(dec)
	err = dec.Error()
	return
}
...
func (s t_server_stub) getTransactions(ctx context.Context, args []byte) (res []byte, err error) {
	...
	// Encode the results.
	enc := codegen.NewEncoder()
	mx_enc_slice_Transaction_d2a36fba(enc, r0)
	enc.Error(appErr)
	return enc.Data(), nil
}
...
func mx_enc_slice_Transaction_d2a36fba(enc *codegen.Encoder, arg []model.Transaction) {
	if arg == nil {
		enc.Len(-1)
		return
	}
...
func mx_dec_slice_Transaction_d2a36fba(dec *codegen.Decoder) []model.Transaction {
	n := dec.Len()
	if n == -1 {
		return nil
	}
