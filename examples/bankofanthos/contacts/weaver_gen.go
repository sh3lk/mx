...
func init() {
	codegen.Register(codegen.Registration{
		Name:  "github.com/sh3lk/mx/examples/bankofanthos/contacts/T",
		Iface: reflect.TypeOf((*T)(nil)).Elem(),
		Impl:  reflect.TypeOf(impl{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return t_local_stub{impl: impl.(T), tracer: tracer, addContactMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/examples/bankofanthos/contacts/T", Method: "AddContact", Remote: false, Generated: true}), getContactsMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/examples/bankofanthos/contacts/T", Method: "GetContacts", Remote: false, Generated: true})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return t_client_stub{stub: stub, addContactMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/examples/bankofanthos/contacts/T", Method: "AddContact", Remote: true, Generated: true}), getContactsMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/sh3lk/mx/examples/bankofanthos/contacts/T", Method: "GetContacts", Remote: true, Generated: true})}
		},
...
func (s t_client_stub) AddContact(ctx context.Context, a0 string, a1 Contact) (err error) {
	...
	size := 0
	size += (4 + len(a0))
	size += mx_size_Contact_15811618(&a1)
...
func (s t_client_stub) GetContacts(ctx context.Context, a0 string) (r0 []Contact, err error) {
	...
	// Decode the results.
	dec := codegen.NewDecoder(results)
	r0 = mx_dec_slice_Contact_d00a3378(dec)
	err = dec.Error()
	return
}
...
func (s t_server_stub) getContacts(ctx context.Context, args []byte) (res []byte, err error) {
	...
	// Encode the results.
	enc := codegen.NewEncoder()
	mx_enc_slice_Contact_d00a3378(enc, r0)
	enc.Error(appErr)
	return enc.Data(), nil
}
...
func (x *Contact) MXMarshal(enc *codegen.Encoder) {
	if x == nil {
		panic(fmt.Errorf("Contact.MXMarshal: nil receiver"))
	}
...
func (x *Contact) MXUnmarshal(dec *codegen.Decoder) {
	if x == nil {
		panic(fmt.Errorf("Contact.MXUnmarshal: nil receiver"))
	}
...
func mx_enc_slice_Contact_d00a3378(enc *codegen.Encoder, arg []Contact) {
	if arg == nil {
		enc.Len(-1)
		return
	}
...
func mx_dec_slice_Contact_d00a3378(dec *codegen.Decoder) []Contact {
	n := dec.Len()
	if n == -1 {
		return nil
	}
...
// mx_size_Contact_15811618 returns the size (in bytes) of the serialization
// of the provided type.
func mx_size_Contact_15811618(x *Contact) int {
	size := 0
	size += 0
